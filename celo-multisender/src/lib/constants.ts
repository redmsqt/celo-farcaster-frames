 ...
 */
export const APP_NAME = "Celo Multi Sender";
...
export const APP_DESCRIPTION =
  "A Celo multi sender mini app. Send tokens to multiple addresses at once.";
 ...
 */
export const APP_TAGS = ["send", "celo", "demo"];
...
export const MultiSendContract = "0xA1b265C3Ed5dCdff6A329a2f1a12A14d7B977959";
